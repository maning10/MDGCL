...
def k_mer(seq):
    ...
    def get_8mer(seq):
        ...
        while i + 8 < len(seq):
            ...
            res_dict[k] = res_dict[k] + 1
        return [x/len(seq) for x in list(res_dict.values())]
    return get_1mer(seq) + get_2mer(seq) + get_3mer(seq) + get_4mer(seq)+get_5mer(seq)+get_6mer(seq)+get_7mer(seq)+get_8mer(seq)
